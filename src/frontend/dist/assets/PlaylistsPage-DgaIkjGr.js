...
import { b as ProtocolError, T as TimeoutWaitingForResponseErrorCode, d as utf8ToBytes, E as ExternalError, e as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, R as RequestStatusResponseStatus, U as UnknownError, f as RequestStatusDoneNoReplyErrorCode, g as RejectError, h as CertifiedRejectErrorCode, i as UNREACHABLE_ERROR, I as InputError, k as InvalidReadStateRequestErrorCode, m as ReadRequestType, n as Principal, o as IDL, p as MissingCanisterIdErrorCode, H as HttpAgent, q as encode, Q as QueryResponseStatus, s as UncertifiedRejectErrorCode, t as isV3ResponseBody, v as isV2ResponseBody, w as UncertifiedRejectUpdateErrorCode, x as UnexpectedErrorCode, y as decode, S as Subscribable, z as pendingThenable, A as resolveEnabled, B as shallowEqualObjects, D as resolveStaleTime, F as noop$1, G as environmentManager, J as isValidTimeout, K as timeUntilStale, N as timeoutManager, O as focusManager, V as fetchState, W as replaceData, X as notifyManager, Y as hashKey, Z as getDefaultState, r as reactExports, _ as shouldThrowError, $ as useQueryClient, a0 as useInternetIdentity, a1 as createActorWithConfig, c as createLucideIcon, a2 as React, a3 as React2, j as jsxRuntimeExports, a4 as reactDomExports, a5 as ReactDOM, a6 as cn, M as Music2, u as usePlayerStore, P as Play, a7 as ue, a8 as Record, a9 as Opt, aa as Vec, ab as Service, ac as Func, ad as Nat, ae as Nat8, af as Text, ag as Bool, ah as Skeleton, L as ListMusic } from "./index-CGKCIHSA.js";
import { u as useComposedRefs, c as composeRefs, B as Button, b as buttonVariants } from "./button-4FcoecDk.js";
import { u as useLayoutEffect2, c as createContextScope, a as createSlot, b as useCallbackRef$1, P as Primitive, d as composeEventHandlers, e as dispatchDiscreteCustomEvent, f as useDirection, g as Presence, h as createContext2, X, S as ScrollArea, i as createSlottable } from "./scroll-area-CyQ8eFu-.js";
...
function PlaylistCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      "data-ocid": `playlists.item.${index2}`,
      "aria-label": `Open playlist ${playlist.name}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-lg bg-muted flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Music2, { className: "w-5 h-5 text-primary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground truncate text-sm leading-tight", children: playlist.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: trackCount === 0 ? "No tracks" : trackCount === 1 ? "1 track" : `${trackCount} tracks` })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              "data-ocid": `playlists.open_modal_button.${index2}`,
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  DropdownMenuItem,
                  {
                    ...
                    "data-ocid": `playlists.edit_button.${index2}`,
                    children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  DropdownMenuItem,
                  {
                    ...
                    "data-ocid": `playlists.delete_button.${index2}`,
                    children: [
...
function PlaylistDetail({
  ...
  function handlePlayAll() {
    ...
    setPlaying(true);
    ue.success(`Playing "${playlist.name}"`);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", "data-ocid": "playlists.detail.panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-4 py-3 bg-card border-b border-border shrink-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-foreground truncate text-base leading-tight", children: playlist.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: playlistTracks.length === 0 ? "No tracks" : playlistTracks.length === 1 ? "1 track" : `${playlistTracks.length} tracks` })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 space-y-2", children: playlistTracks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "flex flex-col items-center justify-center gap-3 py-12 text-center",
        "data-ocid": "playlists.detail.empty_state",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-muted flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Music2, { className: "w-8 h-8 text-muted-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "This playlist is empty." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Add tracks to get started." })
        ]
      }
    ) : playlistTracks.map((track, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded bg-muted flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Music2, { className: "w-4 h-4 text-muted-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground truncate leading-tight", children: track.title }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-3 border-t border-border bg-card shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        type: "button",
        variant: "outline",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: pickerOpen, onOpenChange: setPickerOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      DialogContent,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { className: "px-5 pt-5 pb-3 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "text-base font-bold text-foreground", children: [
              "Add to ",
              playlist.name
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 pb-5 space-y-2", children: availableTracks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "text-center py-8 text-muted-foreground text-sm",
              "data-ocid": "playlists.detail.picker_empty_state",
              children: "All library tracks are already in this playlist."
            }
          ) : availableTracks.map((track, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4 text-primary opacity-0 group-hover:opacity-100 shrink-0" })
              ]
            },
            track.id.toString()
          )) }) })
...
Service({
  ...
  "addTrack": Func(
    [Text, Text, Nat, ExternalBlob],
    [TrackInfo],
    []
  ),
  "addTrackToPlaylist": Func([Nat, Nat], [Bool], []),
  "createPlaylist": Func([Text], [PlaylistInfo], []),
  "deletePlaylist": Func([Nat], [Bool], []),
  "deleteTrack": Func([Nat], [Bool], []),
  "getPlaylist": Func([Nat], [Opt(PlaylistInfo)], ["query"]),
  "getSession": Func([], [SessionInfo], ["query"]),
  "getTrack": Func([Nat], [Opt(TrackInfo)], ["query"]),
  "listPlaylists": Func([], [Vec(PlaylistInfo)], ["query"]),
  "listTracks": Func([], [Vec(TrackInfo)], ["query"]),
  "removeTrackFromPlaylist": Func([Nat, Nat], [Bool], []),
  "renamePlaylist": Func([Nat, Text], [Bool], []),
  "saveSession": Func([Opt(Nat), Nat], [], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const PlaylistInfo2 = IDL2.Record({
    "id": IDL2.Nat,
    "name": IDL2.Text,
    "trackIds": IDL2.Vec(IDL2.Nat)
  });
  const SessionInfo2 = IDL2.Record({
    "lastPosition": IDL2.Nat,
    "lastTrackId": IDL2.Opt(IDL2.Nat)
  });
  return IDL2.Service({
    ...
    "addTrack": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Nat, ExternalBlob2],
      [TrackInfo2],
      []
    ),
    "addTrackToPlaylist": IDL2.Func([IDL2.Nat, IDL2.Nat], [IDL2.Bool], []),
    "createPlaylist": IDL2.Func([IDL2.Text], [PlaylistInfo2], []),
    "deletePlaylist": IDL2.Func([IDL2.Nat], [IDL2.Bool], []),
    "deleteTrack": IDL2.Func([IDL2.Nat], [IDL2.Bool], []),
    "getPlaylist": IDL2.Func([IDL2.Nat], [IDL2.Opt(PlaylistInfo2)], ["query"]),
    "getSession": IDL2.Func([], [SessionInfo2], ["query"]),
    "getTrack": IDL2.Func([IDL2.Nat], [IDL2.Opt(TrackInfo2)], ["query"]),
    "listPlaylists": IDL2.Func([], [IDL2.Vec(PlaylistInfo2)], ["query"]),
    "listTracks": IDL2.Func([], [IDL2.Vec(TrackInfo2)], ["query"]),
    "removeTrackFromPlaylist": IDL2.Func([IDL2.Nat, IDL2.Nat], [IDL2.Bool], []),
    "renamePlaylist": IDL2.Func([IDL2.Nat, IDL2.Text], [IDL2.Bool], []),
    "saveSession": IDL2.Func([IDL2.Opt(IDL2.Nat), IDL2.Nat], [], [])
  });
};
...
class Backend {
  ...
  async addTrack(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
  ...
  async addTrackToPlaylist(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async removeTrackFromPlaylist(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async renamePlaylist(arg0, arg1) {
    if (this.processError) {
      try {
...
function from_candid_SessionInfo_n13(_uploadFile, _downloadFile, value) {
  return from_candid_record_n14(_uploadFile, _downloadFile, value);
}
async function from_candid_TrackInfo_n9(_uploadFile, _downloadFile, value) {
...
function PlaylistsPage() {
  ...
  const openPlaylist = (playlists == null ? void 0 : playlists.find((p) => p.id === openId)) ?? null;
  function openCreate() {
    setNameInput("");
  ...
  async function handleCreate() {
    ...
    try {
      ...
      ue.success(`"${trimmed}" created`);
      closeModal();
    } catch {
      ue.error("Failed to create playlist");
    }
  }
  async function handleRename() {
    if ((modal == null ? void 0 : modal.type) !== "rename") return;
    const trimmed = nameInput.trim();
    if (!trimmed) return;
    try {
      await renamePlaylist.mutateAsync({ id: modal.id, name: trimmed });
      ue.success("Playlist renamed");
      closeModal();
    } catch {
      ue.error("Failed to rename playlist");
    }
  }
  async function handleDelete() {
    if ((modal == null ? void 0 : modal.type) !== "delete") return;
    try {
      await deletePlaylist.mutateAsync(modal.id);
      if (openId === modal.id) setOpenId(null);
      ue.success(`"${modal.name}" deleted`);
      closeModal();
    } catch {
      ue.error("Failed to delete playlist");
    }
  }
  function handleRemoveTrack(playlistId, trackId) {
    removeTrackFromPlaylist.mutate(
      { playlistId, trackId },
      {
        onSuccess: () => ue.success("Track removed"),
        onError: () => ue.error("Failed to remove track")
      }
    );
  }
  function handleAddTrack(playlistId, trackId) {
    addTrackToPlaylist.mutate(
      { playlistId, trackId },
      {
        onSuccess: () => ue.success("Track added"),
        onError: () => ue.error("Failed to add track")
      }
    );
  }
  if (openPlaylist) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", "data-ocid": "playlists.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3 bg-card border-b border-border shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-base font-bold text-foreground", children: "Playlists" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4", children: loadingPlaylists ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "playlists.loading_state", children: Array.from({ length: 4 }).map((_, i) => (
      // biome-ignore lint/suspicious/noArrayIndexKey: skeleton
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-16 w-full rounded-xl bg-muted" }, i)
    )) }) : !playlists || playlists.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "flex flex-col items-center justify-center gap-4 py-20 text-center",
        "data-ocid": "playlists.empty_state",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-full bg-muted flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ListMusic, { className: "w-10 h-10 text-muted-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-base", children: "No playlists yet" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Create your first playlist to organize your music." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "playlists.list", children: playlists.map((playlist, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      PlaylistCard,
      {
        playlist,
        index: i + 1,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Dialog,
      {
        open: (modal == null ? void 0 : modal.type) === "create" || (modal == null ? void 0 : modal.type) === "rename",
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          DialogContent,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-foreground", children: (modal == null ? void 0 : modal.type) === "create" ? "New Playlist" : "Rename Playlist" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "form",
                {
                  onSubmit: (e) => {
                    e.preventDefault();
                    if ((modal == null ? void 0 : modal.type) === "create") handleCreate();
                    else handleRename();
                  },
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Button,
                        {
                          ...
                          disabled: !nameInput.trim() || createPlaylist.isPending || renamePlaylist.isPending,
                          "data-ocid": "playlists.confirm_button",
                          children: (modal == null ? void 0 : modal.type) === "create" ? "Create" : "Save"
                        }
                      )
                    ] })
                  ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AlertDialog,
      {
        open: (modal == null ? void 0 : modal.type) === "delete",
        onOpenChange: (open) => !open && closeModal(),
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          AlertDialogContent,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { className: "text-foreground", children: "Delete playlist?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogDescription, { className: "text-muted-foreground", children: (modal == null ? void 0 : modal.type) === "delete" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  "“",
                  modal.name,
